...
if not ENVIRONMENT:
    raise ValueError("No ENVIRONMENT set for Django settings")
...
INSTALLED_APPS = [
    ...
    "db",  # database models, repositories, helpers
    "tools",  # management and everything that makes life easier
]

MIDDLEWARE = [
    # additional OWASP middleware
    "corsheaders.middleware.CorsMiddleware",  # positioned at the top to ensure it runs first
