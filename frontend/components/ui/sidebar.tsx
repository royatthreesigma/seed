...
/**
 * SidebarInset - Main content area that sits alongside the sidebar.
 *
 * Note: `min-w-0` and `overflow-hidden` are critical for proper layout.
 * Without them, content with horizontal overflow (e.g., kanban boards,
 * wide tables) will push the container beyond viewport bounds instead
 * of scrolling within. This is because flex items default to
 * `min-width: auto`, preventing them from shrinking below content size.
 */
